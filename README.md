...
☕ Cafe Lezzet Otomasyon Sistemi Bu proje, bir kafenin günlük operasyonlarını (giriş, masa yönetimi, sipariş ve ödeme) dijital ortamda yönetmek için geliştirilmiş Java Swing tabanlı ve MySQL veritabanı bağlantılı bir masaüstü uygulamasıdır.
...
🛠 Kullanılan Teknolojiler Dil: Java (JDK 17+)
...
📂 Proje Yapısı ve Mimari Proje, N-Tier (Çok Katmanlı) mimariye yakın bir yapıda kurgulanmıştır:
